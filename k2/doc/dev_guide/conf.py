...
project = 'K2 Development Guide'
copyright = '2017-2018, Zenterio AB'
...
latex_documents = [
    (master_doc, 'dev_guide.tex', 'K2 Development Guide',
...
man_pages = [
    (master_doc, 'K2 Dev Guide', 'K2 Development Guide',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dev_guide', 'K2 Development Guide',
